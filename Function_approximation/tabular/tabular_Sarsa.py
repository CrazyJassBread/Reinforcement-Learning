# https://github.com/viniciusenari/Q-Learning-and-SARSA-Mountain-Car-v0/blob/main/train_sarsa.py
# 将连续状态拆分成足够细的离散状态来训练agent
...
save_obj(Q, 'Function_approximation/tabular/pre-trained-SARSA.pkl')